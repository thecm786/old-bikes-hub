...
`;
      ...
      alert(
        "Message send nahi ho paya. Please try again."
      );
        ...
        <div className="mx-auto max-w-7xl">
          ...
          <div className="max-w-3xl">
            ...
            <p className="mt-5 max-w-2xl text-base leading-7 text-gray-300 md:text-lg">
              Have a question about buying, selling, or
              listing a used bike? Our team is here to
              help you.
            </p>
          ...
          <div className="rounded-3xl bg-black p-8 text-white shadow-xl md:p-10">
            ...
            <div className="mb-8">
              ...
              <p className="mt-4 leading-7 text-gray-400">
                Have a question about a bike, selling your
                bike, or anything related to Old Bikes Hub?
              ...
              <div className="flex items-center gap-4 rounded-2xl bg-white/10 p-4">
                ...
                <div className="min-w-0">
                  ...
                  <a
                    ...
                    className="break-all font-bold transition hover:text-orange-500"
                  >
                    {siteConfig.email}
                  </a>
            ...
            <div className="mt-8 rounded-2xl border border-white/10 bg-white/5 p-5">
              ...
              <p className="mt-2 text-sm leading-6 text-gray-400">
                Trusted platform for buying and selling
                used bikes. Our team is here to provide
